...
import kotlinx.android.synthetic.main.item_email_address_card_content.view.*


class EmailAddressViewHolder(itemView: View, listener: OnRecyclerItemClickListener) : BaseViewHolder <CardContent, OnRecyclerItemClickListener>(itemView, listener), LayoutContainer {
