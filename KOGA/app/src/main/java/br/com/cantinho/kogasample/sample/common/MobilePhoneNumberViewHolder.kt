...
import kotlinx.android.synthetic.main.item_mobile_phone_number_card_content.view.*


class MobilePhoneNumberViewHolder(itemView: View, listener: OnRecyclerItemClickListener) : BaseViewHolder <CardContent, OnRecyclerItemClickListener>(itemView, listener), LayoutContainer {
